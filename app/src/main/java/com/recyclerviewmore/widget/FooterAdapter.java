package com.recyclerviewmore.widget;
...
public class FooterAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> implements View.OnClickListener, View.OnLongClickListener {
    ...
    public FooterAdapter(RecyclerViewUpRefresh recyclerViewUpRefresh, LoadingMoreFooter loadingMoreFooter, RecyclerView.Adapter adapter) {
        this.recyclerView = recyclerViewUpRefresh;
